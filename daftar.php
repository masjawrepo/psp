    ...
    <body>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                ...
                <div id="form-title" class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                ...
                <div id="form-body" class="row g-5 align-items-center text-center justify-content-center">

...
// If the user is not logged in redirect to the login page...
	...
	if (isset($_SESSION['loggedin-nakes']) || isset($_SESSION['loggedin-psp'])) {
		if ($_SESSION['loggedin-psp'] == True) {
			header('Location: admin/index-psp.php');
			exit;
		}
		else if ($_SESSION['loggedin-nakes'] == True) {
			header('Location: admin/index-nakes.php');
			exit;
		}
	}	
	global $site; 
                ...
                <div class="container py-5">
					...
					<div class="row g-5 align-items-center text-center justify-content-center">
						<div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
							<h2 class="display-5 mb-2">Akses Akun Nakes</h2>
							<p class="mb-4">Masuk ke Akun Kamu Untuk Menggunakan Fitur-Fitur dari <a class="text-primary fw-bold">Aplikasi PillSync+</a>.</p>
							<form autocomplete="off" action="admin/webapi/adminwebapi.php?function=signin" method="post" >
								<div class="row g-3">
									<div class="col-12">
